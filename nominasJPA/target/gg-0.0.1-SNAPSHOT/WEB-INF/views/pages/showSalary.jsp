...
<body>
	<h1 align="center">
		<a type="button" class="btn btn-success"
			href="${pageContext.request.contextPath}">Back</a>Salarios
	</h1>
	...
	<ul id="navegador" class="nav nav-tabs">
		...
		<li class="nav-item "><a class="nav-link "
			href="modify">Modificar
				empleados</a></li>
		<li class="nav-item activo"><a class="nav-link"
	...
	<div class="container">
		...
		<form name="Enviar"
			action="salary"
			method="post">
			<input type="text" name="consulta" value="Introduce DNI" /> <input
