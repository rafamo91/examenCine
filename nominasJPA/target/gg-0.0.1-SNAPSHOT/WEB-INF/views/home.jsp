...
<body>
	...
	<div class="container">
		<p>En esta aplicación ofrecemos las siguientes posibilidades:</p>
		<ul>
			...
			<li>Realizar una consulta personalizada con las combinaciones de
				parámetros que el usuario desee</li>
			<li>Modificar los datos de cualquier usuario controlado desde
				JSP y Servlet ya que la Base de datos dependerá de la que disponga
				el usuario, aunque se ofrecerá el .SQL</li>
			<li>Calcular de forma interna el salario de los trabajadores, de
				forma que no quede reflejada en la base de datos</li>

			<li>Error para la comprobación la ventana error:<br>---Introducir tres
				nombres en el input nombre en la pestaña modificación de usuarios---</li>
